...
public interface ICustomBackground
{
     ...
     *
     * @param left      the x coord of the left side of the {@link com.dyn.betterachievements.gui.GuiBetterAchievements}
     * @param top       the y coord of the top side of the {@link com.dyn.betterachievements.gui.GuiBetterAchievements}
     * @param width     the width of the {@link net.minecraft.client.gui.achievement.GuiAchievement}
     * @param height    the height of the {@link com.dyn.betterachievements.gui.GuiBetterAchievements}
     * @param z         the z level
