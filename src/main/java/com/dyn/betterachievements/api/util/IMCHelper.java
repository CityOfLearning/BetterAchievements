...
/**
 * Used to send an IMC message containing the {@link ItemStack} to render on the
 * tab in {@link com.dyn.betterachievements.gui.GuiBetterAchievements} of the
 * given {@link AchievementPage} Can be used as replacement for
 * {@link com.dyn.betterachievements.api.components.page.ICustomIcon} NOTE: IMC
 * will most likely register before the {@link ICustomIcon#getPageIcon()} will
 * ever be called In short this will override what ever is set there, so use
 * only one of both
 */
