...
import com.dyn.betterachievements.reference.Resources;
...
public class GuiBetterAchievements extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        //this.buttonList.add(new GuiButton(buttonOld, this.left + buttonOffsetX, this.height / 2 + buttonOffsetY, 125, 20, I18n.format("com.dyn.betterachievements.gui.old")));
    ...
    protected void actionPerformed(GuiButton button)
    {
        switch (button.id)
        {
            ...
            case buttonPrev: //this is causing an index out of bounds error
            	...
            	newOffset -= maxTabs;
                if (newOffset == -maxTabs) newOffset = this.pages.size() - maxTabs / 3 * 2;
                else if (newOffset < 0) this.tabsOffset = 0;
                break;
            case buttonNext:
                this.tabsOffset += maxTabs;
